...
import { ButtonBox, Contents, ListItem, Top, TopLeft } from "./indexCss";

export default function MainThird() {
  const { backgroundColor, currentSetIndex } = useColorStore();
  return (
    <Contents>
      <ListItem
        onClick={() =>
      ...
      >
        ...
        <p>개인작업, 아르바이트, 교육수료 등을 통해 쌓은 디자인 포트폴리오</p>
      </ListItem>
      <ListItem>
        <Top>
          <TopLeft>
